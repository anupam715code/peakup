...
<?php
$breadcrumb = array(
    'javascript:void(0)' => 'Add New User'
);
?>
...
<div class="m-content">
    ...
    <div class="m-portlet">
        ...
        <!--begin::Form-->
        {{ Form::open(array('url' => config('constants.ADMIN_URL').'save-user', 'class' => 'm-form m-form--fit m-form--label-align-right', 'method' => 'post', 'id' => 'm_form_1', 'files' => true)) }}
